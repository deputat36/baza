...
ARTIFACTS = [
    ("Главное", [
        ...
        ("Доверие источников", "source-trust-report.md", "Уровни доверия источников и правила использования записей"),
        ("Доверие источников CSV", "source-trust-report.csv", "Табличная версия уровней доверия источников"),
        ("Жизненный цикл", "record-lifecycle-report.md", "Статусы записей от черновика до архива"),
        ("Жизненный цикл CSV", "record-lifecycle-report.csv", "Табличная версия жизненного цикла записей"),
        ...
        ("Проверка контактов", "contact-verification-report.md", "Регламент актуализации закрытых контактов"),
        ("Проверка контактов CSV", "contact-verification-report.csv", "Табличная версия проверки контактов"),
