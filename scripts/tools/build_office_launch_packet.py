...
PACKET_ITEMS = [
    ...
    ("18", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("19", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("20", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("21", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("22", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("23", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("24", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("25", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("26", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
