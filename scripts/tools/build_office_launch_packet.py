...
PACKET_ITEMS = [
    ...
    ("17", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("18", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("19", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("20", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("21", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("22", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("23", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("24", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("25", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
