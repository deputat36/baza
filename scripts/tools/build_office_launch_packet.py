...
PACKET_ITEMS = [
    ...
    ("15", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("16", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("17", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("18", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("19", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("20", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("21", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("22", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("23", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
