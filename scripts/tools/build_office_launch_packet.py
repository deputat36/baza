...
PACKET_ITEMS = [
    ...
    ("19", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("20", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("21", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("22", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("23", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("24", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("25", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("26", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("27", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
