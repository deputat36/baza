...
PACKET_ITEMS = [
    ...
    ("17", "Департаменты", "department-routing-report.md", "Проверить маршруты к кураторам центрального офиса"),
    ("18", "Закрытые контакты", "private-contact-schema-report.md", "Проверить поля приватного реестра контактов"),
    ("19", "Проверка контактов", "contact-verification-report.md", "Проверить регламент актуализации закрытых контактов"),
    ("20", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("21", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("22", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("23", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("24", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("25", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("26", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("27", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("28", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
