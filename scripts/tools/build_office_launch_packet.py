...
PACKET_ITEMS = [
    ...
    ("04", "Управление", "manager-dashboard.md", "Разобрать WARN и ближайшие действия"),
    ("05", "Готовность", "launch-readiness-report.md", "Проверить READY/CHECK/DRAFT по разделам"),
    ("06", "Ответственность", "section-ownership-report.md", "Проверить владельцев критичных разделов"),
    ("07", "Приемка", "office-acceptance-test-report.md", "Пройти блокирующие сценарии по ролям"),
    ("08", "Обучение", "role-training-report.md", "Проверить блокирующие блоки обучения"),
    ("09", "Запуск", "office-launch-checklist-report.md", "Закрыть задачи, блокирующие запуск"),
    ("10", "Эксплуатация", "operating-rhythm-report.md", "Проверить регулярные задачи после запуска"),
    ("11", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("12", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("13", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("14", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("15", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("16", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
