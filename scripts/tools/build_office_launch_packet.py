...
PACKET_ITEMS = [
    ...
    ("05", "Управление", "manager-dashboard.md", "Разобрать WARN и ближайшие действия"),
    ("06", "Готовность", "launch-readiness-report.md", "Проверить READY/CHECK/DRAFT по разделам"),
    ("07", "Ответственность", "section-ownership-report.md", "Проверить владельцев критичных разделов"),
    ("08", "Приемка", "office-acceptance-test-report.md", "Пройти блокирующие сценарии по ролям"),
    ("09", "Обучение", "role-training-report.md", "Проверить блокирующие блоки обучения"),
    ("10", "Запуск", "office-launch-checklist-report.md", "Закрыть задачи, блокирующие запуск"),
    ("11", "Эксплуатация", "operating-rhythm-report.md", "Проверить регулярные задачи после запуска"),
    ("12", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("13", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("14", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("15", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("16", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("17", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("18", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("19", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("20", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
