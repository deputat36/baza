...
PACKET_ITEMS = [
    ...
    ("18", "Департаменты", "department-routing-report.md", "Проверить маршруты к кураторам центрального офиса"),
    ("19", "Закрытые контакты", "private-contact-schema-report.md", "Проверить поля приватного реестра контактов"),
    ("20", "Проверка контактов", "contact-verification-report.md", "Проверить регламент актуализации закрытых контактов"),
    ("21", "Актуальность", "data-freshness-report.md", "Проверить просроченные и непроверенные разделы"),
    ("22", "Предложения", "change-request-report.md", "Разобрать открытые предложения сотрудников"),
    ("23", "Импорт", "import-plan.md", "Проверить порядок переноса в закрытую Google Таблицу"),
    ("24", "Листы", "google-sheet-tabs-plan.md", "Проверить структуру будущей Google Таблицы"),
    ("25", "Валидации", "google-sheet-validation-plan.md", "Проверить выпадающие списки и справочники"),
    ("26", "Оформление", "google-sheet-formatting-plan.md", "Проверить правила оформления статусов"),
    ("27", "Безопасность", "integration-access-report.md", "Проверить матрицу доступа к закрытым данным"),
    ("28", "Контракты", "integration-contract-report.md", "Проверить готовность read-only контрактов"),
    ("29", "Совместимость", "knowledge-index.json", "Проверить наличие JSON-индекса знаний"),
]
