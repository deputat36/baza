...
launch-packet: manager-dashboard role-navigation ownership acceptance-tests role-training go-no-go launch-decision office-launch operating-rhythm usage-metrics adoption-plan weekly-digest manager-actions department-routing source-trust record-lifecycle private-contact-schema contact-verification import-plan tabs-plan validation-plan formatting-plan integration-access integration-contracts knowledge-index
