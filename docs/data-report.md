...
Они помогают быстро увидеть наполненность разделов, порядок листов, порядок импорта, полноту XLSX-сборки, возможные проблемы с ID и согласованность заголовков.
