...
План оформления закрытой Google Таблицы:
...
Они помогают быстро увидеть наполненность разделов, порядок листов, выпадающие списки, оформление, порядок импорта, полноту XLSX-сборки, возможные проблемы с ID и согласованность заголовков.
