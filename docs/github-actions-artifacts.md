...
6. Открыть XLSX и проверить структуру листов.
7. Открыть `import-plan.md` и сверить порядок переноса.
8. Открыть `data-report.md` и оценить наполненность разделов.
9. Открыть `source-coverage-report.md` и проверить CSV, которые не входят в XLSX.
10. Открыть `id-registry.md` и проверить возможные дубли ID.
11. Открыть `schema-report.md` и проверить заголовки CSV.
