...
7. Открыть XLSX и проверить структуру листов.
8. Открыть `import-plan.md` и сверить порядок переноса.
9. Открыть `data-report.md` и оценить наполненность разделов.
10. Открыть `source-coverage-report.md` и проверить CSV, которые не входят в XLSX.
11. Открыть `id-registry.md` и проверить возможные дубли ID.
12. Открыть `schema-report.md` и проверить заголовки CSV.
